...
public class CommandInvalid: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CommandInvalid else { return false }
    ...
    public static func == (lhs: CommandInvalid, rhs: CommandInvalid) -> Bool {
