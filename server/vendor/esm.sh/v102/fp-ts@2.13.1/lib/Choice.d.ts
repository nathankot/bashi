...
import { HKT2, Kind2, Kind3, URIS2, URIS3, URIS4, Kind4 } from './HKT/HKT.d.ts'
import { Profunctor, Profunctor2, Profunctor3, Profunctor4 } from './Profunctor.d.ts'
import { Category, Category2, Category3, Category4 } from './Category.d.ts'
/**
 * @category model
 * @since 2.0.0
 */
