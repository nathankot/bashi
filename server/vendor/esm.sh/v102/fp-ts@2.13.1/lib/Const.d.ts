...
import { BooleanAlgebra } from './BooleanAlgebra.d.ts'
import { Bounded } from './Bounded.d.ts'
import { Contravariant2 } from './Contravariant.d.ts'
import { Eq } from './Eq.d.ts'
import { Functor2 } from './Functor.d.ts'
import { HeytingAlgebra } from './HeytingAlgebra.d.ts'
import { Monoid } from './Monoid.d.ts'
import { Ord } from './Ord.d.ts'
import { Ring } from './Ring.d.ts'
import { Semigroup } from './Semigroup.d.ts'
import { Semiring } from './Semiring.d.ts'
