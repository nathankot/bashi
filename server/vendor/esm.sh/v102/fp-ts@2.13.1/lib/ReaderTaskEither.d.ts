...
import { Apply1, Apply3 } from './Apply.d.ts'
...
import { FromIO3 } from './FromIO.d.ts'
import { FromReader3 } from './FromReader.d.ts'
import { FromTask3 } from './FromTask.d.ts'
...
import { MonadIO3 } from './MonadIO.d.ts'
import { MonadTask3, MonadTask3C } from './MonadTask.d.ts'
...
import * as RIO from './ReaderIO.d.ts'
import * as RT from './ReaderTask.d.ts'
...
import * as TE from './TaskEither.d.ts'
