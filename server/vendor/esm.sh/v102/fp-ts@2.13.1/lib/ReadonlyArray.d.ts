...
import { Alternative1 } from './Alternative.d.ts'
...
import { Compactable1 } from './Compactable.d.ts'
import { Either } from './Either.d.ts'
import { Eq } from './Eq.d.ts'
import { Extend1 } from './Extend.d.ts'
import { Filterable1 } from './Filterable.d.ts'
import { FilterableWithIndex1, PredicateWithIndex, RefinementWithIndex } from './FilterableWithIndex.d.ts'
import { Foldable1 } from './Foldable.d.ts'
import { FoldableWithIndex1 } from './FoldableWithIndex.d.ts'
import { FromEither1 } from './FromEither.d.ts'
import { Lazy } from './function.d.ts'
import { Functor1 } from './Functor.d.ts'
import { FunctorWithIndex1 } from './FunctorWithIndex.d.ts'
...
import * as RNEA from './ReadonlyNonEmptyArray.d.ts'
...
import { PipeableTraverseWithIndex1, TraversableWithIndex1 } from './TraversableWithIndex.d.ts'
import { Unfoldable1 } from './Unfoldable.d.ts'
import { PipeableWilt1, PipeableWither1, Witherable1 } from './Witherable.d.ts'
import { Zero1 } from './Zero.d.ts'
 ...
 * @since 2.11.0
 */
export declare const filterE: import('./Witherable.d.ts').FilterE1<'ReadonlyArray'>
/**
 * @category instances
 * @since 2.11.0
 */
