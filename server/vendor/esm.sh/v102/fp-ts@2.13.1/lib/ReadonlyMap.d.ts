import { Compactable2 } from './Compactable.d.ts'
import { Either } from './Either.d.ts'
import { Eq } from './Eq.d.ts'
import { Filterable2 } from './Filterable.d.ts'
import { FilterableWithIndex2C } from './FilterableWithIndex.d.ts'
import { Foldable, Foldable1, Foldable2, Foldable2C, Foldable3 } from './Foldable.d.ts'
import { FoldableWithIndex2C } from './FoldableWithIndex.d.ts'
import { Functor2 } from './Functor.d.ts'
import { FunctorWithIndex2C } from './FunctorWithIndex.d.ts'
import { HKT, Kind, Kind2, Kind3, URIS, URIS2, URIS3 } from './HKT/HKT.d.ts'
import { Magma } from './Magma.d.ts'
import { Monoid } from './Monoid.d.ts'
import * as O from './Option.d.ts'
...
import { Traversable2C } from './Traversable.d.ts'
import { TraversableWithIndex2C } from './TraversableWithIndex.d.ts'
import { Unfoldable, Unfoldable1 } from './Unfoldable.d.ts'
import { Witherable2C } from './Witherable.d.ts'
