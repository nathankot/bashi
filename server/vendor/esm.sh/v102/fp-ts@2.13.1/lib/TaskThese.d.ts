...
import { Apply1, Apply2C } from './Apply.d.ts'
...
import { FromTask2 } from './FromTask.d.ts'
...
import { MonadTask2C } from './MonadTask.d.ts'
...
import * as T from './Task.d.ts'
import * as TH from './These.d.ts'
