...
import { FoldableWithIndex, FoldableWithIndex1, FoldableWithIndex2, FoldableWithIndex2C } from './FoldableWithIndex.d.ts'
import { FunctorWithIndex, FunctorWithIndex1, FunctorWithIndex2, FunctorWithIndex2C } from './FunctorWithIndex.d.ts'
import { HKT, Kind, Kind2, Kind3, URIS, URIS2, URIS3 } from './HKT/HKT.d.ts'
import { Traversable, Traversable1, Traversable2, Traversable2C } from './Traversable.d.ts'
/**
 * @since 2.0.0
 */
