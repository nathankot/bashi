 ...
 * @since 2.0.0
 */
import { Alt, Alt1, Alt2, Alt2C, Alt3, Alt3C, Alt4 } from './Alt.d.ts'
import { Apply, Apply1, Apply2, Apply2C, Apply3, Apply3C, Apply4 } from './Apply.d.ts'
import { Bifunctor, Bifunctor2, Bifunctor2C, Bifunctor3, Bifunctor3C, Bifunctor4 } from './Bifunctor.d.ts'
import { Chain, Chain1, Chain2, Chain2C, Chain3, Chain3C, Chain4 } from './Chain.d.ts'
import {
  Compactable,
  Compactable1,
  Compactable2,
  ...
  Compactable3C,
  Compactable4
} from './Compactable.d.ts'
import { Separated } from './Separated.d.ts'
import {
  Contravariant,
  Contravariant1,
  Contravariant2,
  ...
  Contravariant3C,
  Contravariant4
} from './Contravariant.d.ts'
import { Either } from './Either.d.ts'
import { Extend, Extend1, Extend2, Extend2C, Extend3, Extend3C, Extend4 } from './Extend.d.ts'
import {
  Filterable,
  Filterable1,
  Filterable2,
...
import {
  ...
  PredicateWithIndex,
  RefinementWithIndex
} from './FilterableWithIndex.d.ts'
import { Foldable, Foldable1, Foldable2, Foldable2C, Foldable3, Foldable3C, Foldable4 } from './Foldable.d.ts'
import {
  FoldableWithIndex,
  FoldableWithIndex1,
  FoldableWithIndex2,
  ...
  FoldableWithIndex3C,
  FoldableWithIndex4
} from './FoldableWithIndex.d.ts'
import { Lazy, pipe as pipeFromFunctionModule } from './function.d.ts'
import { Predicate } from './Predicate.d.ts'
import { Refinement } from './Refinement.d.ts'
import { Functor, Functor1, Functor2, Functor2C, Functor3, Functor3C, Functor4 } from './Functor.d.ts'
import {
  FunctorWithIndex,
  FunctorWithIndex1,
  FunctorWithIndex2,
  ...
  FunctorWithIndex3C,
  FunctorWithIndex4
} from './FunctorWithIndex.d.ts'
import { HKT, HKT2, Kind, Kind2, Kind3, Kind4, URIS, URIS2, URIS3, URIS4 } from './HKT/HKT.d.ts'
import {
  MonadThrow,
  MonadThrow1,
  MonadThrow2,
  ...
  MonadThrow3C,
  MonadThrow4
} from './MonadThrow.d.ts'
import { Monoid } from './Monoid.d.ts'
import { Option } from './Option.d.ts'
import { Profunctor, Profunctor2, Profunctor2C, Profunctor3, Profunctor3C, Profunctor4 } from './Profunctor.d.ts'
import {
  Semigroupoid,
  Semigroupoid2,
  Semigroupoid2C,
