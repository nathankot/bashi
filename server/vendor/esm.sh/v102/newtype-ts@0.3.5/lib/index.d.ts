 ...
 * @since 0.2.0
 */
import { Field } from 'https://esm.sh/v102/fp-ts@2.13.1/lib/Field/lib/index.d.ts';
import { Predicate } from 'https://esm.sh/v102/fp-ts@2.13.1/lib/function/lib/index.d.ts';
...
import { Ring } from 'https://esm.sh/v102/fp-ts@2.13.1/lib/Ring/lib/index.d.ts';
import { Semigroup } from 'https://esm.sh/v102/fp-ts@2.13.1/lib/Semigroup/lib/index.d.ts';
import { Semiring } from 'https://esm.sh/v102/fp-ts@2.13.1/lib/Semiring/lib/index.d.ts';
import { Eq } from 'https://esm.sh/v102/fp-ts@2.13.1/lib/Eq/lib/index.d.ts';
import { Iso, Prism } from 'https://esm.sh/v102/monocle-ts@2.3.13/lib/index.d.ts';
/**
 * @since 0.2.0
 */
