...
/// <reference path="https://esm.sh/v103/node.ns.d.ts" />
/// <reference path="https://esm.sh/v103/node.ns.d.ts" />
import { EventEmitter } from 'https://esm.sh/v103/@types/node@16.18.10/events.d.ts';
import * as net from 'https://esm.sh/v103/@types/node@16.18.10/net.d.ts';
import * as tls from 'https://esm.sh/v103/@types/node@16.18.10/tls.d.ts';
