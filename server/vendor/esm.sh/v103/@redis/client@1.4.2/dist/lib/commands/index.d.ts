...
import { ClientCommandOptions } from '../client/index.d.ts';
import { CommandOptions } from '../command-options.d.ts';
import { RedisScriptConfig, SHA1 } from '../lua-script.d.ts';
